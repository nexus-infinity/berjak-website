...
$thing_name = "Sieve Analysis";


include("header.php");

$id = (int)$_REQUEST['id'];
$p = new sieve_analysis($id);
...
if($_POST['submit']) {
    ...
    echo "<input type='submit' name='submit' value='Create another Sieve Analysis'>";
    echo "</form>";


    echo ">>> <a href='editproduct.php?id=$product_id'>Edit Product.</a><br>";
    echo ">>> <a href='editsieve_analysis.php?id=$id'>Edit " . $thing_name . " again.</a><br>";
    echo ">>> <a href='index.php'>Admin page.</a><br>";
    echo ">>> <a href='../'>Front page.</a><br>";
    ...
    echo "<tr>";
    echo "<td>Aperture microns</td>";
    echo "<td><input type='text' name='aperture_microns' value='" . $p->sfh('aperture_microns') . "'></td>";
    echo "<td>eg. + 250</td>";
    echo "</tr>";

    echo "<tr>";
    echo "<td>Retained</td>";
    echo "<td><input type='text' name='retained' value='" . $p->sfh('retained') . "'></td>";
    echo "<td>eg.  0.2</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>Cumulative Retained</td>";
    echo "<td><input type='text' name='cumulative_retained' value='" . $p->sfh('cumulative_retained') . "'></td>";
    echo "<td>eg. 0.2</td>";
    echo "</tr>";
