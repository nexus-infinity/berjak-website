...
if($_POST['submit']) {
    ...
    echo ">>> <a href='editchemicals.php?id=$id'>Edit " . $thing_name . " again.</a><br>";
    echo ">>> <a href='index.php'>Admin page.</a><br>";
    echo ">>> <a href='../'>Front page.</a><br>";
    ...
    echo "<td><input type='text' name='description' value='" . $p->sfh('description') . "'></td>";
    echo "<td>eg.  Minimum</td>";
    echo "</tr>";

    echo "<tr>";
    echo "<td>Guaranteed</td>";
    echo "<td><input type='text' name='guaranteed' value='" . $p->sfh('guaranteed') . "'></td>";
    echo "<td>eg.  95.00%</td>";
    echo "</tr>";

    echo "<tr>";
    echo "<td>Typical</td>";
    echo "<td><input type='text' name='typical' value='" . $p->sfh('typical') . "'></td>";
    echo "<td>eg.  96.00%</td>";
    echo "</tr>";
